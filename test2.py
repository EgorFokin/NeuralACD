...
with open("1/plane_cache.json", "r") as plane_cache_f:
    plane_cache.update(json.load(plane_cache_f))

with open("2/plane_cache.json", "r") as plane_cache_f:
    plane_cache.update(json.load(plane_cache_f))

with open("3/plane_cache.json", "r") as plane_cache_f:
    plane_cache.update(json.load(plane_cache_f))

with open("4/plane_cache.json", "r") as plane_cache_f:
    plane_cache.update(json.load(plane_cache_f))

with open("5/plane_cache.json", "r") as plane_cache_f:
    plane_cache.update(json.load(plane_cache_f))
